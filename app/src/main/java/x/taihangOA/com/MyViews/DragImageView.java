...
public class DragImageView extends ImageView {
	...
	public void setmActivity(Activity mActivity, ImageView imageView) {
	...
	public void setImageResource(int resId) {
		...
		Bitmap bmp = BitmapUtil.ReadBitmapById(mActivity, resId, window_width,
				window_height);
		// setImageBitmap(bmp);
		bitmap_W = bmp.getWidth();
		bitmap_H = bmp.getHeight();
...
////		bitmap_W = drawable.getWidth();
////		bitmap_H = bitmap.getHeight();
////		bitmap_W=drawable.getIntrinsicWidth();
////		bitmap_H=drawable.getIntrinsicHeight();
//		MAX_W = bitmap_W * 3;
//		MAX_H = bitmap_H * 3;
//
//		MIN_W = bitmap_W / 2;
...
//	}
	...
	public void getgetViewTreeObserver() {
				...
				.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
					...
					public void onGlobalLayout() {
						if (state_height == 0) {
							...
							screen_H = window_height - state_height;
